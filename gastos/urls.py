...
urlpatterns = [
    ...
    path('gastos/<int:pk>/atualizar_gasto/', atualizar_gasto, name='atualizar_gasto'),
    ...
    path('receita/<int:pk>/atualizar/', atualizar_receita, name='atualizar_receita'),
    path('listar_receita/', listar_receita, name='listar_receita'),
    path('receita/<int:pk>/deletar_receita/', remover_receita, name='deletar_receita'),
